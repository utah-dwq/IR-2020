...
### Manually assigning AUs & uses to out-of-state sites (for non-assessment dataset)
...
### Assign criteria
prof_crit=read.csv(file='P:/WQ/Integrated Report/IR_2020/2020-IR-assessments/assessment/03_lake_assessments/lake_prof_criteria.csv')
...
### Tier 2 assessments
#### Phytoplankton
phyto_data=as.data.frame(readxl::read_excel('P:/WQ/Integrated Report/IR_2020/2020-IR-assessments/assessment/03_lake_assessments/lake_phytoplankton.xlsx', 'data'))
phyto_sites=as.data.frame(readxl::read_excel('P:/WQ/Integrated Report/IR_2020/2020-IR-assessments/assessment/03_lake_assessments/lake_phytoplankton.xlsx', 'sites'))
...
prev_asmnt=read.csv('P:/WQ/Integrated Report/IR_2020/2020-IR-assessments/assessment/03_lake_assessments/previous_lake_assessments.csv')
...
asmnt2020_au_param=rollUp(data=list(prof_asmnts$profile_asmnts_mlid_param), group_vars=c('ASSESS_ID','AU_NAME','BeneficialUse','R3172ParameterName'), cat_var='AssessCat', print=F, expand_uses=F)
...
writexl::write_xlsx(list(lake_profile_asmnts=comb_asmnt_au),
		path = 'P:/WQ/Integrated Report/IR_2020/2020-IR-assessments/assessment/03_lake_assessments/lake_profile_asmnts.xlsx', format_headers=F, col_names=T)


## Save objects
save.image('P:/WQ/Integrated Report/IR_2020/2020-IR-assessments/assessment/03_lake_assessments/lake_assessments.Rdata')
save(trophic_data, prof_asmnts_all, phyto_data, file='P:/WQ/Integrated Report/IR_2020/2020-IR-assessments/assessment/03_lake_assessments/lake_data_for_app.Rdata')
