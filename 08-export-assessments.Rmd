...
```{r}
sjr_thallium = subset(prelim_asmnts, prelim_asmnts$ASSESS_ID%in%c("UT14080205-001_00","UT14080201-009_00")&prelim_asmnts$R3172ParameterName=="Thallium"&prelim_asmnts$new_listing=="Y")
...
prelim_asmnts = merge(prelim_asmnts, sjr_thallium, all.x = TRUE)
prelim_asmnts = merge(prelim_asmnts, millrace_copper_zinc, all.x = TRUE)
prelim_asmnts = merge(prelim_asmnts, provoriver_do, all.x = TRUE)
