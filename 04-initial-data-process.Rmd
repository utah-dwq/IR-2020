...
test=applyScreenTable(subset(acc_data, !is.na()), wb=translation_wb, sheetname="paramTransTable", startRow=4, flag_col_name="IR_Parameter_FLAG", com_col_name="IR_Parameter_COMMENT")
table(test$IR_Parameter_FLAG, exclude=NULL)
...
#updateParamTrans(data=acc_data, detquantlim=irdata$detquantlim,  translation_wb=translation_wb, 
#				 paramTransTable_startRow = 4, paramTransTable_startCol = 18,
#				 WQPParamCASID_startRow = 4, WQPParamCASID_startCol = 1)
...
names(merged_results_filled)[names(merged_results_filled) %in% names(stds)]

assignCriteria(merged_results_filled, crit_wb='IR_uses_standards_working.xlsx', crit_sheetname='criteria', ss_sheetname='ss_criteria',
